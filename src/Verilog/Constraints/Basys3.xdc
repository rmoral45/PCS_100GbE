...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports i_fpga_clock]
	set_property IOSTANDARD LVCMOS33 [get_ports i_fpga_clock]
create_clock -period 40.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports i_fpga_clock]
